...
const Authors = () => {
  return (
    <div className="dark:text-white dark:bg-black">
      ...
      <div className="grid md:grid-cols-4 sm:grid-cols-1 gap-5 px-4 pb-[70px] justify-center ">
        <div className="relative border-2 rounded-md h-[400px] flex flex-col items-center justify-center">
          <img
            src="https://images.pexels.com/photos/819530/pexels-photo-819530.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
            className="w-[100px] h-[100px] md:w-[200px] md:h-[200px] object-cover rounded-full mb-4"
          />
        ...
        <div className=" relative border-2 rounded-md md:h-[400px] w-[400px] flex flex-col items-center justify-center">
          <img
            src="https://images.pexels.com/photos/450214/pexels-photo-450214.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
            className="w-[200px] h-[200px] md:w-[200px] md:h-[200px] object-cover rounded-full mb-4"
          />
          <p className="text-center font-semibold text-xl">John Doe</p>
          <div className="mt-3 flex items-center gap-2 bg-gray-100 p-2 px-5 border-2 rounded-full">
            <p className="text-xl text-normal dark:text-black">18 Articles</p>
